          ...
          <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href="#contact"
                  className="rounded-2xl bg-slate-900 text-white px-5 py-3 text-sm font-medium shadow-sm hover:bg-slate-800"
                >
                  Get in touch
                </a>
                <a
                  href="#experience"
                  className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-medium hover:bg-slate-100"
                >
                  View experience
                </a>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-6 pt-16">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-5">
              ...
              <div className="rounded-3xl bg-white/5 border border-white/10 p-6">
                ...
                <p className="mt-3 text-sm text-slate-300">
                  Data cleaning, transformation, merging datasets, and quality assurance.
                </p>
              </div>
              <div className="rounded-3xl bg-white/5 border border-white/10 p-6">
                <h4 className="text-lg font-semibold">Visualization</h4>
                <p className="mt-3 text-sm text-slate-300">
                  Dashboards and reports using Power BI, Excel, and Python visualizations.
                </p>
              </div>
            </div>
          </div>
